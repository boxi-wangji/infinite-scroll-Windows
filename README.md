...
# Windows终端 其实自带多开，我偶然触发。。。

# Windows Terminal 快捷键速查表
| 分类 | 功能 | 快捷键 |
| :--- | :--- | :--- |
| **分屏** | 自动拆分 | `Alt + Shift + D` |
| **分屏** | 垂直拆分 | `Alt + Shift + +` |
| **分屏** | 水平拆分 | `Alt + Shift + -` |
| **分屏** | 切换焦点 | `Alt + 方向键` |
| **分屏** | 调整尺寸 | `Alt + Shift + 方向键` |
| **分屏** | 关闭分屏 | `Ctrl + Shift + W` |
| **标签** | 新建标签页 | `Ctrl + Shift + T` |
| **标签** | 切换标签页 | `Ctrl + (Shift) + Tab` |
| **标签** | 查找内容 | `Ctrl + Shift + F` |
| **全局** | **命令面板** | `Ctrl + Shift + P` |
| **全局** | 全屏切换 | `F11` |
| **全局** | 放大/缩小字号 | `Ctrl + +/-` |
| **全局** | 重置字号 | `Ctrl + 0` |
